...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 23, 2024 at 05:45 PM
...
(31, 'Metode nuklir', 'Univ binaniaga', '2024', '2024-12-24', 22);
...
--
ALTER TABLE `penelitian`
  MODIFY `kd_penelitian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
COMMIT;
